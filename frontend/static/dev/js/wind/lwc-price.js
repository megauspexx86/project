...
(function ($lwc) {
    ...
    var profil = p.profil = {};
    profil.fav = 13.20;      // Фаворит 71 мм
    profil.bau = 11.20;      // Баутек 71 мм
    profil.grain = 12.30;     // Grain Prestige 70 мм
    ...
    glass.spo24 = 30.9;       // однокамерный 24
    glass.spd32 = 47.3;       // двухкамерный 32
    glass.spd40 = 49.1;       // двухкамерный 40
    ...
    sill.result = "pr[d][houses[e.houses.val()]]";    // формула
    ...
    //mnt[$lwc.houses.wooden] = "(m.w + m.h) * 2 * 20";     // монтаж в считаем не по площади, а как 20 единиц валюты на каждый метр периметра изделия
    mnt[$lwc.houses.wooden] = "Production * 0.2";     // монтаж в считаем не по площади, а как 20% от стоимости изделия
