...
/**
 * Сущность для письма ЗАКАЗЧИКУ, информирующего о том, что заказ оплачен полностью(сразу на 100%)
 * Class EmlOrderPayFullToCustomer
 * @package Email\Objects
 */
class EmlOrderPayFullToCustomer extends Email {

	/**
	 * EmlOrderPayFullToCustomer constructor.
	 * @param CUser $user
	 * @param COrder $order
	 */
	...
	public function template() {
		return 'order_pay_full_to_customer.tpl';
	}
